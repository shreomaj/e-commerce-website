...
import com.springboot.ecommerce.util.AppConstant;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	@Cacheable(cacheNames="usersGet", key="#email")
...
//wrong password attempt count
	...
	public void userAccountLock(UserDtls user) {
		user.setAccountNonLocked(false);//sccount locked
		user.setLockTime(new Date());
		userRepository.save(user);
	}
//account has got unlocked or not
	@Override
