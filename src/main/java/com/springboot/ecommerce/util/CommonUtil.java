...
////	public CommonUtil(JavaMailSender mailSender, UserService userService, String msg) {
////		super();
...
//
	public Boolean sendMail(String url, String reciepentEmail) throws UnsupportedEncodingException, MessagingException {
		...
		helper.setFrom("wright.shreoshi@gmail.com", "Shooping Cart");
	...
	public static String generateUrl(HttpServletRequest request) {
		...
		//request.getServletPath()=> http://localhost:8080
	}
//	
	String msg=null;;
